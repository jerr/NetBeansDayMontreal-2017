== cdi-logger-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The cdi-logger-addon addon enables blah blah...)
...
----
<dependency>
   <groupId>org.netbeansdaymtl.forge.addons</groupId>
   <artifactId>cdi-logger-addon</artifactId>
